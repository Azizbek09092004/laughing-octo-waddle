...
final class OqtepaCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        imageView.image = UIImage(named: "oqtepawall")
...
final class OqtepaCell2: UICollectionViewCell {
    let imageView: UIImageView = {
        let imageView = UIImageView()
    ...
    let titleLabel: UILabel = {
        let label = UILabel()
        label.text = "Uzum Tezkordan Do'stlar uchun"
