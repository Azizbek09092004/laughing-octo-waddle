...
final class EvosCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        imageView.image = UIImage(named: "evoswall")
...
final class EvosCell2: UICollectionViewCell {
    let imageView: UIImageView = {
        let imageView = UIImageView()
    ...
    let titleLabel: UILabel = {
        let label = UILabel()
        label.text = "Evosdan Pepsi kombosi"
